...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250629060447_AddBookView")]
            ...
            modelBuilder.Entity("Domain.Entities.BookView", b =>
                {
                    ...
                    b.Property<bool>("IsAvailable")
                        .HasColumnType("bit")
                        .HasComputedColumnSql("(CASE WHEN EXISTS (SELECT 1 FROM BookCopies WHERE BookId = Id AND IsAvailable = 1) THEN 1 ELSE 0 END)");
