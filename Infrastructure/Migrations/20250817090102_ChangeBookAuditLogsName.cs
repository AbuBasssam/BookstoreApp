...
{
    /// <inheritdoc />
    public partial class ChangeBookAuditLogsName : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Rename the table from BookAuditLogs to BookActivityLogs
            migrationBuilder.Sql("EXEC sp_rename 'BookAuditLogs', 'BookActivityLogs';");

            // Alter the existing trigger for Add New Book Record with the correct audit log table name
...
END;");
            ...
            // Alter the trigger for Book updates with the correct audit log table name
            migrationBuilder.Sql(@"
...
END;");
        ...
        {
            // Rename the table back from BookActivityLogs to BookAuditLogs
            migrationBuilder.Sql("EXEC sp_rename 'BookActivityLogs', 'BookAuditLogs';");
